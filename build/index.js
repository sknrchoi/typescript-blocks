...
class Blockchain {
    ...
    getBlocks() {
        return [...this.blocks]; // return new array - connected blocks state
    }
}
...
// this is not connected blocks state
blockchain.getBlocks().push(new Block("fake blocks", 11111, "HACKED"));
